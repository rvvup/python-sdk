...
T = TypeVar("T", bound="WebhookCreateInputHeadersType0")


@_attrs_define
class WebhookCreateInputHeadersType0:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        webhook_create_input_headers_type_0 = cls()
        ...
        webhook_create_input_headers_type_0.additional_properties = (
            additional_properties
        )
        return webhook_create_input_headers_type_0
