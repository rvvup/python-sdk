...
T = TypeVar("T", bound="CheckoutCustomerFieldsUpdateInput")
...
class CheckoutCustomerFieldsUpdateInput:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        checkout_customer_fields_update_input = cls(
            optional=optional,
            required=required,
        )

        checkout_customer_fields_update_input.additional_properties = d
        return checkout_customer_fields_update_input
