...
T = TypeVar("T", bound="CheckoutApplePaySettingsUpdateInput")
...
class CheckoutApplePaySettingsUpdateInput:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        checkout_apple_pay_settings_update_input = cls(
            capture_type=capture_type,
            customer_fields=customer_fields,
        )

        checkout_apple_pay_settings_update_input.additional_properties = d
        return checkout_apple_pay_settings_update_input
