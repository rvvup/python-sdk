...
T = TypeVar("T", bound="CheckoutPayByBankSettings")
...
class CheckoutPayByBankSettings:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        checkout_pay_by_bank_settings = cls(
            capture_type=capture_type,
            customer_fields=customer_fields,
        )

        checkout_pay_by_bank_settings.additional_properties = d
        return checkout_pay_by_bank_settings
