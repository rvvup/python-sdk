...
T = TypeVar("T", bound="CheckoutPayByBankSettingsInput")


@_attrs_define
class CheckoutPayByBankSettingsInput:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        checkout_pay_by_bank_settings_input = cls(
            capture_type=capture_type,
            customer_fields=customer_fields,
        )

        checkout_pay_by_bank_settings_input.additional_properties = d
        return checkout_pay_by_bank_settings_input
