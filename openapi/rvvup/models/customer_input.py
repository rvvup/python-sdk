...
class CustomerInput:
    ...
    Attributes:
        ...
        given_name (Union[Unset, str]): The customer's given name. Example: John.
        phone_number (Union[Unset, str]): The customer's phone number.
        surname (Union[Unset, str]): The customer's surname. Example: Doe.
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        customer_input.additional_properties = d
