...
T = TypeVar("T", bound="CheckoutApplePaySettingsInput")


@_attrs_define
class CheckoutApplePaySettingsInput:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        checkout_apple_pay_settings_input = cls(
            capture_type=capture_type,
            customer_fields=customer_fields,
        )

        checkout_apple_pay_settings_input.additional_properties = d
        return checkout_apple_pay_settings_input
